...
from utils.string_utils import get_validated_message
...
class CaesarSingleKeyFrame(ctk.CTkFrame):
    def __init__(self, parent, load_main_menu):
        ...
        setup_options_column(
            ...
            caesar_single_key_encryption, operation_name="Encrypt")
        ...
        setup_options_column(
            ...
            caesar_single_key_decryption, operation_name="Decrypt")
    ...
    def process_message(input_textarea, output_textarea, key, error_label, function):
        ...
        if not key:
            error_label.configure(text='provide an integer key')
            return
        ...
        processed_message = function(message, int(key))
