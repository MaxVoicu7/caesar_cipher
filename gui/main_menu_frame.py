...
class MainMenuFrame(ctk.CTkFrame):
    def __init__(self, parent, single_key_method, double_key_method, break_caesar_method, vigenere_method, rsa_method):
        ...
        create_menu_button(self, 'Vigenere Cipher', vigenere_method, (0, 10))
        create_menu_button(self, 'RSA', rsa_method, (0, 10))
